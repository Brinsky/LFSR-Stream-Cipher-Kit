...
public interface Lfsr {
   ...
   *
   * <p>The least significant bit in the returned vector represents the bit that will be output by
   * the next shift operation. The remaining higher- order bits follow consecutively.
   *
   ...
   *
   * <p>The bit with the an index of 0 is the bit that will be output by the next shift operation.
   * The remaining higher-order bits are indexed consecutively.
   *
   ...
   *
   * <p>The least significant bit in this vector corresponds to the position whose bit will be
   * output by the next shift operation. The remaining higher-order bits correspond to the remaining
   ...
   * it is not.
   *
   * <p>The bit with an index of 0 corresponds to the position whose bit will be output by the next
   * shift operation. The remaining higher-order bits are indexed consecutively.
   *
   ...
   *
   * <p>The least significant bit in the vector should describe the bit that will be output by the
   * next shift operation. The remaining higher-order bits should follow consecutively.
   *
   ...
   *
   * <p>The bit with an index of 0 corresponds to the bit that will be output by the next shift
   * operation. The remaining higher-order bits are indexed consecutively.
   *
   * @param index The position of the desired bit within the fill.
   ...
   *
   * <p>The least significant bit in the vector should correspond to the position in the register of
   * the bit that will be output by the next shift operation. The remaining higher-order bits should
   ...
   *
   * <p>The bit with an index of 0 corresponds to the position of the bit that will be output by the
   * next shift operation. The remaining higher- order bits are indexed consecutively.
   *
   * <p>A value of 1 indicates that the specified position should be tapped, and a value of 0
   * indicates that it should not be.
   *
