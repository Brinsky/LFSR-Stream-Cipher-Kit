...
public class LongLfsr extends AbstractLfsr {
	 ...
	 * 	{@link Lfsr#setTaps(BitVector)}.
	 * @param fill A {@code BitVector} representing the fill. See
	 * 	{@link Lfsr#setFill(BitVector)}.
	 */
	 ...
	 * 
	 * @param length The length of the register to be created.
	 * @param taps A {@code long} representing the tap configuration. See
	 * 	{@link Lfsr#setTaps(long)}.
	 * @param fill A {@code long} representing the fill. See
	 * 	{@link Lfsr#setFill(long)}.
	 */
