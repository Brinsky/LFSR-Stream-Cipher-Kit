...
public class BitVectorLengthException extends IllegalArgumentException {
  ...
  public static final String WAS_NEGATIVE = "Expected a nonnegative length, got %d";
  public static final String EXCEEDED_LIMIT = "Expected a length between 0 and %d, got %d";
