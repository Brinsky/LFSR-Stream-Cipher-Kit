...
public class BitSetBitVector extends BitVector {
	...
	// We cannot extract the first byte or long of the BitSet when no bits are
	// 1, so we track this case separately.
	 ...
	 * 
	 * @param bits A list of bits, ordered from least-signficant to most-
